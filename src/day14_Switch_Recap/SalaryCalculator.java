        ...
        if (hourlyRate > 0) {
            ...
            if (weeklyHours > 1 && weeklyHours <= 65) {
                if (numberOfWeeks > 1 && numberOfWeeks <= 52) {
                    ...
                    System.err.println("Number of weeks cannot be less than one or more than 52");
                }

            } else {
                System.err.println("Weekly hours cannot be less than 1 or more than 65");
            }
