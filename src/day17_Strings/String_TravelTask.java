      ...
      The base cost of the ticket should be set to: 1000
        ...
        > if the user enters false:
            ...
            Print: "Looks like your password has been expired for $years, but not to worry
             we will get it ready for you to travel to $allCountries. Your total cost has come
             out to $costAmount."
 */

import java.util.Scanner;

public class String_TravelTask {
    public static void main(String[] args) {
        ...
        if (validPassport.equalsIgnoreCase("yes")) {
            ...
            input.nextLine();//to accept the next input
            ...
            System.out.println("How many people you are travelling with?");
            ...
            input.nextLine();
            System.out.println("Enter names of people you will travel with");
            String namesOfPeople = input.nextLine();


            System.out.println("Your ticket is booked to " + country + ". We have charged extra for the " +
                    bags + " bags but you are traveling\n with " + numOfPeople
                    + " person/people, so we are giving a discount. Your total cost is: " + cost);

        } else {//if no passport

            cost = 200;

            System.out.println("How many years has your passport been expired?");
            int expDatePass = input.nextInt();
            cost += (expDatePass * 75);

            input.nextLine();

            System.out.println("Which countries are you planning to travel to?" +
                    "\nSeparate each country with a comma.");

             String country1 = input.nextLine();

            System.out.println("Are you planning to travel next year? Yes/No");
            String travelNextYear = input.next();
            ...
            System.out.println("Looks like your passport has been expired for " + expDatePass+ " years, but not to worry " +
                            "we will get it ready for you to travel \nto "+ country1 + ". Your total cost has come out to " +cost+ ".");
