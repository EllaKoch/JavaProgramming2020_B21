...
// create a method that combines double array, String array, char Array
public class MethodOverLoading5 {
    public static void main(String[] args) {
        ...
        char[] chars1 = {'a', 'e'};
        char[] chars2 = {'f','g','w'};
        char[] chars3 = {'r','s','t','q','P'};

        char[] chars4 = combineTwoArrays(combineTwoArrays(chars1,chars2),chars3);
