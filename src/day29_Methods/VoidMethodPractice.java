...
public class VoidMethodPractice {
    public static void main(String[] args) {
        ...
        int[] a1 = {100, -200, 300, 50, 59, 700, 0, 1, 2};
        arrayMaxNum(a1);
        arrayMinNum(a1);

        int[] a2 = {1, 2, 3, 4, 5, 6, 7, 8, 9, 800, 90, 1, 2, 3, 4};
        arrayMaxNum(a2);
        arrayMinNum(a2);
        ...
        int[] a4 = {12,10,8,11,11,11,9};
        arrayUniqueElements(a4);

    }
//              AM  Specifier   returnType  MethodName (Parameter){ statements }
