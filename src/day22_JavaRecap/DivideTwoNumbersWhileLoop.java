...
/*
    ...
    4. write a program that can divide two numbers without using / & % operators and
     returns the division and remainder
            ex:
                input:  10
                        3
                Output:
 ...
 */
public class DivideTwoNumbersWhileLoop {
    public static void main(String[] args) {
        ...
        System.out.println(count+ " with a remainder of " + a);//whatever left in the numerator is the remainder
