...
public class StringPractice3 {
    public static void main(String[] args) {
        ...
        sentence = sentence.replace("Canada", "The United States");
        ...
        String r = "cava is cool, I like to learn cava at cybertek school";

        r = r.replace("ca", "ja");
        System.out.println(r);

//        String p = "I like Java and Java Java Java Java Java Java Java";
//
//        p = p.replace("Java", "").replace("like ", "like C#");
//        p = p.replace("d    ", "d Java");
//
