...
public class Book {
    ...
    public void setTitle(String title) {
        if (!title.contains(" ")) {//first and single word
            this.title = capitalize(title);
        } else if (title.isEmpty()) {// if title is empty
            this.title = "";
            ...
            for (int i = 0; i < arr.length; i++) {
                if (i == 0) {
                    ...
                    if (isTitleWord(arr[i]) == false) {
                        this.title += arr[i].toLowerCase() + " ";
                    }
                    if (isTitleWord(arr[i]) == true) {
                        this.title += capitalize(arr[i]) + " ";
                    }
                }
            }
