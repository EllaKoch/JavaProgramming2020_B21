...
import day26_Arrays.Test;

public class FaceBook {
    public static void main(String[] args) {

        ProductOwner PO = new ProductOwner("Marwan Subhi", "1234", 'M', 12000, true);

        BusynessAnalyst BA = new BusynessAnalyst("Ayse", "A02", 'F', 150000, true);
        ...
        System.out.println( scrumTeam.getBusynessAnalyst());
