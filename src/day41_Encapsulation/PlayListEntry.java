...
In addition, your PlayList class definition should provide an appropriately named "get"
method and "set" method for each of these variables that can return the values of each of variable.
