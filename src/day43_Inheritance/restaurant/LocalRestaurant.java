...
public class LocalRestaurant {
    public static void main(String[] args) {
        ...
        Chef[] chefs = {new Chef("Halim", 23, 'M', 25, "Head Cook", "C003"),
        ...
        restaurant.hireServer(new Server("Mani", 25, 'M', 20, "server", "1234"));
        ...
        //display the names of the servers
...
Create a class LocalRestaurant that has a main method with the following:
            ...
            servers to the ArrayList of the Restaurant object
            - Create an array of chefs with their information set. Add those initial chefs
            to the ArrayList of the Restaurant object
